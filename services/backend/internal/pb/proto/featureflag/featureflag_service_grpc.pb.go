...
const (
	FeatureFlagService_GetFeatureFlags_FullMethodName = "/featureflag.FeatureFlagService/GetFeatureFlags"
)
...
type FeatureFlagServiceClient interface {
	// GET http://localhost:8080/v1/feature-flags?user_role=Admin
...
var FeatureFlagService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/featureflag/featureflag_service.proto",
}
